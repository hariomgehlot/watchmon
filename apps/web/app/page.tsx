    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-purple-950/20 relative overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 py-8">
        <div className="text-center mb-12">
          ...
          <h1 className={"text-4xl  md:text-6xl font-bold mb-4 bg-clip-text animate-pulse text-green-300 " + monster.className}>
            watchmon
          </h1>
        ...
        <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-8">
          ...
          <Card className="glass-card border-purple-500/20 hover:border-purple-500/40 transition-all duration-300 group">
            <CardHeader className="text-center">
              ...
              <CardTitle className="text-2xl font-bold text-purple-400">Create a Show</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              <p className="text-center text-muted-foreground">
                Start a new show and invite friends to watch together
              </p>
          ...
          <Card className="glass-card border-blue-500/20 hover:border-blue-500/40 transition-all duration-300 group">
            <CardHeader className="text-center">
              ...
              <CardTitle className="text-2xl font-bold text-blue-400">Join a Show</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              <p className="text-center text-muted-foreground">
                Enter a show ID to join an existing show
              </p>
        ...
        <div className="mt-16 text-center">
          <h2 className="text-2xl font-bold mb-8 text-muted-foreground">Why Choose <span className={'text-green-300 '+ monster.className}>watchmon</span>?</h2>
